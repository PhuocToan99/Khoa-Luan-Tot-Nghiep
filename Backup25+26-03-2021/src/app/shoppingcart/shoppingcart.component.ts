...
export class ShoppingcartComponent extends CartBaseComponent {
  ...
  constructor(protected cartService: CartService,private router: Router,private accountincourseService:AccountincourseService,private authenticationService: AuthenticationService,private userService:UserService,private http: HttpClient,private courseService: CourseService,private imageLoadService:ImageloadService) {
    super(cartService);
  ...
  public loadimage(url){
    ...
    updateUserBalance = async (id,price,flag) => {
      try {
        ...
        var user1 = await this.userService.getuser(6) as User;
        console.log(user1);
        ...
        await this.http.put(this.urlAPI+'/6', formData1).toPromise();
       }
       if(paypal){
        var user1 = await this.userService.getuser(6) as User;
        console.log(user1);
