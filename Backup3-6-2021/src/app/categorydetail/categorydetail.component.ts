...
export class CategorydetailComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    public dialog: MatDialog,private chRef: ChangeDetectorRef,private commentService:CommentService) { 
      ...
      // this.bought = (this.currentAccount != null || this.currentAccount != undefined) ? true : false;
...
public loadpage = async () =>{
  ...
  this.Description = this.course.description ? this.course.description.split(".") : [];
  ...
  this.instructor = await this.userservice.getuser(this.course.accountId) as User;
  ...
  if(this.currentAccount == undefined || this.currentAccount == null || courseAlreadeyBought.length == 0){
    ...
    this.bought = (courseAlreadeyBought.find(e => e.courseId == this.id) == undefined) ? false : true;
  }
