...
export class CourseService {
  private readonly urlAPICourse = 'https://localhost:44387/api/Courses';
  constructor(private http: HttpClient) { }
  getcourses = async () => {
    try {
      return await this.http.get(this.urlAPICourse).toPromise();
    }
    catch (e) {
      console.log(e);
    }
  ...
  getallcourses = async () => {
    try {
      return await this.http.get(this.urlAPICourse+"/All").toPromise();
    }
    catch (e) {
      console.log(e);
    }
  ...
  getcourse = async(id) =>{
    try 
    {
      const course = await this.http.get(this.urlAPICourse + "/" + id).toPromise();
      return course;
    }
    catch (e) {
      console.log(e);
  ...
  gettopcourse = async() =>{
    try 
    {
      const course = await this.http.get(this.urlAPICourse + "/Top").toPromise();
      return course;
    }
    catch (e) {
      console.log(e);
  ...
  postcourse = async (course: Course) => {
    ...
    { 
      ...
      const loginUrl = `${this.urlAPICourse}`;
  ...
  deletecourses = async(id) =>{
    try {
      return await this.http.delete(this.urlAPICourse + "/" + id).toPromise();
    }
    catch (e) {
      console.log(e);
    }
  ...
  updatecourses = async (id, course) => {
    try 
    {
      ...
      return await this.http.put(this.urlAPICourse + "/" + id, formData).toPromise();
    }
    catch (e) {
      console.log(e);
    }
