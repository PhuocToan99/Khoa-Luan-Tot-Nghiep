...
namespace API.Controllers
{
    ...
    {
      if (ExamQuizCheckExists(examQuiz.QuizId,examQuiz.ExamCode) != true)
      {
    ...
    //[HttpPost]
    //[Route("AddExamQuiz")]
    //public async Task<ActionResult<ExamQuiz>> PostUser([FromForm] ExamQuiz examQuiz)
    //{
    ...
    //        {
    //          case 1:
    //            examQuiz.ExamOptionImage1 = fileData;
    //            break;
    //          case 2:
    //            examQuiz.ExamOptionImage2 = fileData;
    //            break;
    //          case 3:
    //            examQuiz.ExamOptionImage3 = fileData;
    //            break;
    //          case 4:
    //            examQuiz.ExamOptionImage4 = fileData;
    //            break;
    //          case 5:
    //            examQuiz.ExamOptionImage5 = fileData;
    //            break;
    //        }
    //      }
    //    }
    ...
    //  {
    //    if (!ExamQuizQuestionExists(examQuiz.ExamQuestion))
    //    {
    //      return Conflict();
    //    }
    //    else
    ...
    {
      return await _context.ExamQuizs.Where(e => e.ExamCode == examcode)
        .OrderByDescending(e => e.ExamQuizId)
        .ToListAsync();
    }
    private bool ExamQuizCheckExists(string id,string examCode)
    {
      return _context.ExamQuizs.Any(e => e.QuizId == id && e.ExamCode == examCode);
    }
  }
}
