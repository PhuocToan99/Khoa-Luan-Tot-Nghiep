...
namespace API.Controllers
{
    ...
    public async Task<IEnumerable<AccountinCourse>> GetAccountInCoursesByAccountid(int id)
    {
      var accountinCourse = await _context.AccountinCourses.Where(e => e.AccountId == id).ToListAsync();
