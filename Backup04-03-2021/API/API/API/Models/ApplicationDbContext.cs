  ...
  public class ApplicationDbContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Choice>(entity =>
      {
        ...
        entity.HasOne(a => a.Questionpool).WithMany(u => u.Choices).HasForeignKey(a => a.QuestionpoolId).OnDelete(DeleteBehavior.Restrict);
      });
      ...
      modelBuilder.Entity<Quiz>(entity =>
      {
        ...
        entity.HasOne(a => a.Course).WithMany(u => u.Quizs).HasForeignKey(a => a.CourseId).OnDelete(DeleteBehavior.Restrict);
      });
      ...
      modelBuilder.Entity<Questionpool>(entity =>
      {
        ...
        entity.HasOne(a => a.Quiz).WithMany(u => u.Questionpools).HasForeignKey(a => a.QuizId).OnDelete(DeleteBehavior.Restrict);
      });
    }
    public DbSet<API.Models.Notification> Notification { get; set; }
  }
}
