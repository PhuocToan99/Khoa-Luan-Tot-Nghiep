...
export class ExcelreaderComponent implements OnInit {
  ...
  ,private imageLoadService:ImageloadService,private notification:NotificationService,private datePipe:DatePipe,private commentService:CommentService,private courseService:CourseService) { }
  ...
  //       ratingData.accountId = "1";
  //       ratingData.courseId = "3";
  ...
  //       var ratingRate = (totalRating/ratingList.length).toFixed(1);
  //       var course = await this.courseService.getcourse(ratingData.courseId) as Course;
