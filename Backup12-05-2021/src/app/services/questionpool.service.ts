...
export class QuestionpoolService {
  ...
  getQuestionpoolByContainId = async (courseId: number,lessonId:number) => {
    try {
      return await this.http.get(this.urlAPI+"GetQuestionpool?courseId="+courseId+"&&lessonId="+lessonId).toPromise();
    }
    catch (e) {
      console.log(e);
    }
