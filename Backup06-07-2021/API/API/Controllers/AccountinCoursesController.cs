...
namespace API.Controllers
{
    ...
    public class AccountinCoursesController : ControllerBase
    {
        ...
        public async Task<ActionResult<AccountinCourse>> PostAccountinCourse(AccountinCourse accountinCourse)
        {
            ...
            try
            {
                var result = await _context.AccountinCourses.Where(e => e.CourseId == accountinCourse.CourseId && e.AccountId == accountinCourse.AccountId && e.IsCart == true).ToListAsync();
                _context.AccountinCourses.RemoveRange(result);
                await _context.SaveChangesAsync();
            }
