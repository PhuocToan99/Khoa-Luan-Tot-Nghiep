...
export class ExcelreaderComponent implements OnInit {
  ...
  public addAnswerInput = async (answer:string,flag:boolean,image) =>{
    var choice:Choice = new Choice;
    choice.answer = answer;
    choice.isCorrect = flag;
    if(image != undefined){
