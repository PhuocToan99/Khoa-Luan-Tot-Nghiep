...
export class ExamComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,public quizService: QuizService,private router: Router,public imageService: ImageloadService) { 
    this.route.params
    .subscribe(
      (params: Params) => {
        this.id = +params['id'];
  ...
  async getQuizList(id){
    var result = await this.quizService.getQuizOfQuestionpool(id) as Exam[];
    console.log(result);
