...
export const routing: Routes =[
  ...
  {path: 'exam/:id',component: ExamComponent,canActivate: [CustomguardGuard],data: {role: 'user'}},
  {path: 'examresult',component: ExamresultComponent,canActivate: [CustomguardGuard],data: {role: 'user'}}
]
