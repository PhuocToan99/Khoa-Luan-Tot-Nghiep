...
toggleContent(course:CourseDataSet) {
  ...
  this.courseDataSet[index].course.description = this.isContentToggled ? this.courseDataSet[index].nonFormatedDescription : this.formatContent(this.courseDataSet[index].nonFormatedDescription);
}
