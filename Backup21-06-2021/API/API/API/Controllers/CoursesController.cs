...
namespace API.Controllers
{
  ...
  public class CoursesController : ControllerBase
  {
    ...
    public async Task<ActionResult<IEnumerable<Course>>> FilterCourse(string hastag = null,string courseName = null,int? maxPrice = null,int? minPrice = null, string level = null)
    {
      return await _context.Courses.Where(e => (hastag == null || e.Hastag == hastag) && (level == null || e.Level == level) && (courseName == null || e.CourseName.ToLower().Contains(courseName.ToLower())) && (minPrice == null || e.Price >= minPrice) && (maxPrice == null || e.Price <= maxPrice))
