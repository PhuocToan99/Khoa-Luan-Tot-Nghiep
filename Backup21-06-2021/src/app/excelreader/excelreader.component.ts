...
export class ExcelreaderComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    await this.getBase64ImageFromUrl("https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FImage&psig=AOvVaw0x04ie0jz7bMypsDIdnIfH&ust=1623226530123000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCIiw4oTMh_ECFQAAAAAdAAAAABAD").then(base64 => {
