...
export class SearchComponent implements OnInit {
  ...
  if(this.typeSearch == "advance"){
    this.courses = await this.courseService.getCourseFilter(this.hastag,this.namesearch,this.price,this.level) as Course[];
  ...
  updateState(check:boolean){
    this.searchshow = (check) ? true :false;
    this.typeSearch = (check) ? "advance" : "normal";
  }
  onChange(value,type){
    console.log(value);
    switch(type) { 
